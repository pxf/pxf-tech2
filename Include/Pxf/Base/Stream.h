#ifndef _PXF_BASE_STREAM_H_
#define _PXF_BASE_STREAM_H_
...
public:
	virtual uint Read(void* _Buffer, uint _Size)
	{
		...
		PXF_ASSERT(0, "Stream::Read: Not implemented");
		return 0;
	}
	virtual uint Write(const void* _Buffer, uint _Size)
	{
		...
		PXF_ASSERT(0, "Stream::Write: Not implemented");
		return 0;
	}
