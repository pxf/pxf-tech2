...
namespace Pxf
{
	namespace Network
	{
		...
		public:
			...
			virtual bool Send(const int _Type, const char* _Buf, const int _Length) = 0;
			virtual bool SendID(const char* _ID, const int _Type, const char* _Buf, const int _Length) = 0;
			virtual bool SendPacket(Packet* _Packet) = 0;
		};
	}
}
