...
namespace Pxf
{
	namespace Network
	{
		...
		public:
			...
			virtual bool SendID(const int _Client, const char* _ID, const int _Type, const char* _Buf, const int _Length) = 0;
			virtual bool SendPacket(const int _Client, Network::Packet* _Packet) = 0;
