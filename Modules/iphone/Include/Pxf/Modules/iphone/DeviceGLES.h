#ifndef _PXF_IPHONE_GRAPHICS_DEVICEGLES_H_
#define _PXF_IPHONE_GRAPHICS_DEVICEGLES_H_
...
namespace Pxf{
	...
	namespace Modules {
		class DeviceGLES : public Graphics::GraphicsDevice
		{
		public:
			DeviceGLES(Pxf::Kernel* _Kernel);
			virtual ~DeviceGLES();
...
#endif //_PXF_IPHONE_GRAPHICS_DEVICEGLES_H_
