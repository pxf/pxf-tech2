#ifndef _PXF_GRAPHICS_OPENGL_VERTEXBUFFERGL_H_
#define _PXF_GRAPHICS_OPENGL_VERTEXBUFFERGL_H_
...
namespace Pxf
{
	namespace Graphics
	{
		...
		protected:
			...
			unsigned m_LogTag;
		public:
			VertexBufferGLES(GraphicsDevice* _pDevice, VertexBufferLocation _VertexBufferLocation, VertexBufferUsageFlag _VertexBufferUsageFlag);
...
#endif // _PXF_GRAPHICS_OPENGL_VERTEXBUFFERGL_H_