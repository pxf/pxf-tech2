...
int Fabric::inp_showmouse(lua_State *L) {
	if (lua_gettop(L) == 1)
	{
...
int Fabric::inp_getmousepos (lua_State *L) {
...
int Fabric::inp_setmousepos(lua_State *L) {
...
int Fabric::inp_isbuttondown(lua_State *L) {
...
int Fabric::inp_isbuttonup(lua_State *L) {
...
int Fabric::inp_iskeydown(lua_State *L) {
...
int Fabric::inp_iskeyup(lua_State *L) {
...
int Fabric::inp_getlastchar(lua_State *L)
{
...
int Fabric::inp_clearlastchar(lua_State *L)
{
...
int Fabric::luaopen_appinput (lua_State *L) {
  ...
  luaL_register(L, FABRIC_INPUTLIBNAME, appinputlib);
