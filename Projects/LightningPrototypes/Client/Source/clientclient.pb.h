...
#ifndef PROTOBUF_clientclient_2eproto__INCLUDED
#define PROTOBUF_clientclient_2eproto__INCLUDED
...
namespace lightningclient {

// Internal implementation detail -- do not call these.
void  protobuf_AddDesc_clientclient_2eproto();
void protobuf_AssignDesc_clientclient_2eproto();
void protobuf_ShutdownFile_clientclient_2eproto();
...
class Hello : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_clientclient_2eproto();
  friend void protobuf_AssignDesc_clientclient_2eproto();
  friend void protobuf_ShutdownFile_clientclient_2eproto();
...
class Tasks : public ::google::protobuf::Message {
 public:
  ...
  // repeated .lightningclient.Tasks.Task task = 2;
  inline int task_size() const;
  inline void clear_task();
  static const int kTaskFieldNumber = 2;
  inline const ::lightningclient::Tasks_Task& task(int index) const;
  inline ::lightningclient::Tasks_Task* mutable_task(int index);
  inline ::lightningclient::Tasks_Task* add_task();
  inline const ::google::protobuf::RepeatedPtrField< ::lightningclient::Tasks_Task >&
      task() const;
  inline ::google::protobuf::RepeatedPtrField< ::lightningclient::Tasks_Task >*
      mutable_task();
 ...
 private:
  ...
  ::std::string* batchhash_;
  static const ::std::string _default_batchhash_;
  ::google::protobuf::RepeatedPtrField< ::lightningclient::Tasks_Task > task_;
  friend void  protobuf_AddDesc_clientclient_2eproto();
  friend void protobuf_AssignDesc_clientclient_2eproto();
  friend void protobuf_ShutdownFile_clientclient_2eproto();
...
inline const ::lightningclient::Tasks_Task& Tasks::task(int index) const {
  return task_.Get(index);
}
inline ::lightningclient::Tasks_Task* Tasks::mutable_task(int index) {
  return task_.Mutable(index);
}
inline ::lightningclient::Tasks_Task* Tasks::add_task() {
  return task_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::lightningclient::Tasks_Task >&
Tasks::task() const {
...
#endif  // PROTOBUF_clientclient_2eproto__INCLUDED
